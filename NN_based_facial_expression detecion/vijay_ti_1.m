function feature = SIFT_features(face,iii)
...
if(rem(iii,3) == 0)
    I = f3.*I1;
elseif(rem(iii+1,3) == 0)
    I = f2.*I1;
elseif(rem(iii+2,3) == 0)
    I = f1.*I1;
end
% figure;imshow(I,[]);
I=im2double(I);
...
feature = a(1:500);
% disgusted_features(:,iii) = feature;
% end
% save('Disgusted_Features210by500','disgusted_features');
